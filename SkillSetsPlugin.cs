...
namespace SkillSets
{
	public class SkillSetsPlugin : RocketPlugin<SkillSetsConfiguration>
	{

		public static string WrapLog(string message)
		{
			return string.Format("[SkillSets] {0}", message);
		}

		public static SkillSetsPlugin Instance;
		public List<SkillSet> SkillSets;

		internal ISkillSetsUsersStorage Storage;
		internal DateTime LastPeriodicSave;
		internal bool PeriodicSaveEnabled = false;
		internal uint PeriodicSaveMs;

		public ISkillSetsUsersStorage GetStorage()
		{
			return Storage;
		}
		...
		private ISkillSetsUsersStorage CreateStorage()
		{
		...
		public override TranslationList DefaultTranslations
		{
			get
			{
				return new TranslationList()
				{
					...
					{ "SKILLSET_APPLIED", "SkillSet applied" },
